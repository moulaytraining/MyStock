function getFileData(file,callBack,arg1) {
  ...
  function getIntroPostHtml(fileData,arg1){
      ...
      for (i = 0; i < document.querySelectorAll("#post > div.post-o-lst > ol > li").length; i++) {
        // console.log(i);
        ...
        document.querySelectorAll("#post > div.post-o-lst > ol>li")[i].innerHTML="<b>"+bldText+"</b>"+normText;      
      }  
